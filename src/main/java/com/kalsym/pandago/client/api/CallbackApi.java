...
public class CallbackApi {
     ...
     * **Order Cancellation Callback** * When you cancel an order, if you provided a callback url, pandago will send request to that url. * In the payload, there will be Cancellation object which contains reason and source of cancellation * List of cancellation reasons are provided below.
     * * __NOTE: Cancellation object__ (seen at the end of the payload below) will be provided __only__ when the order is cancelled. It will not be available if the order is not cancelled.          | Cancellation Reason | Description | | - | - | | MISTAKE_ERROR | Incorrect order details  | | REASON_UNKNOWN | Customer cancelled order | | DELIVERY_ETA_TOO_LONG | Other delivery method became available | | UNABLE_TO_FIND | Rider was unable to find the customer  | | TECHNICAL_PROBLEM | System error / technical issue | | NO_COURIER | No riders were available  | | OUTSIDE_SERVICE_HOURS | Order was placed outside of service hours | | COURIER_ACCIDENT | Rider had an accident  | | BAD_WEATHER | Bad weather issue | | OUTSIDE_DELIVERY_AREA | Rider cannot deliver to the area  | | CLOSED | Restaurant was closed | | ADDRESS_INCOMPLETE_MISSTATED | Customer address was incorrect  | | ADDRESS_INCOMPLETE_MISSTATED | Customer address was incorrect  | | COURIER_UNREACHABLE | Rider was unreachable | | FOOD_QUALITY_SPILLAGE | Customer refused to accept order due to spillage | | LATE_DELIVERY | Customer refused to accept order due to late delivery | | UNABLE_TO_PAY | Customer was unable to pay for the order  | | WRONG_ORDER_ITEMS_DELIVERED | Customer refused to accept because items were incorrect |
     * <p><b>200</b> - Success
