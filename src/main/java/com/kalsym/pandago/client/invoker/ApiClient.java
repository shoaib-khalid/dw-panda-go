...
//        }
    ...
    protected RestTemplate buildRestTemplate() {
        ...
        Logger.application.info("isDebugEnabled(): " + Logger.application.isDebugEnabled());
        if (Logger.application.isDebugEnabled()) {
            ClientHttpRequestFactory factory
                    = new BufferingClientHttpRequestFactory(new SimpleClientHttpRequestFactory());
            Logger.application.info("Initializing restTemplate with factory");
            restTemplate = new RestTemplate(factory);
        } else {
            Logger.application.info("Initializing restTemplate");
