...
public class Sender {
  ...
  **/
  ...
  public Sender location(Location location) {
  ...
  **/
  ...
  public Sender notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  **/
  ...
  public Sender clientVendorId(String clientVendorId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, sender.name) &&
        ...
        Objects.equals(this.location, sender.location) &&
        Objects.equals(this.notes, sender.notes) &&
        Objects.equals(this.clientVendorId, sender.clientVendorId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, phoneNumber, location, notes, clientVendorId);
  }
