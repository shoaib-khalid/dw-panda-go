...
public class ErrorResponseForProofOfDelivery {
  @JsonProperty("message")
  private String message = null;

  public ErrorResponseForProofOfDelivery message(String message) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ErrorResponseForProofOfDelivery errorResponseForProofOfDelivery = (ErrorResponseForProofOfDelivery) o;
    return Objects.equals(this.message, errorResponseForProofOfDelivery.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class ErrorResponseForProofOfDelivery {\n");
