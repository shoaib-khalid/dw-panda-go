...
public class Outlet {
    ...
    public Outlet clientVendorId(String clientVendorId) {
    ...
    public Outlet address(String address) {
    ...
    public Outlet street(String street) {
        this.street = street;
        return this;
    }
    ...
    public Outlet streetNumber(String streetNumber) {
    ...
    public Outlet building(String building) {
    ...
    public Outlet district(String district) {
    ...
    public Outlet postalCode(String postalCode) {
    ...
    public Outlet riderInstructions(String riderInstructions) {
    ...
    public Outlet latitude(BigDecimal latitude) {
    ...
    public Outlet longitude(BigDecimal longitude) {
    ...
    public Outlet city(String city) {
        this.city = city;
        return this;
    }
    ...
    public Outlet phoneNumber(String phoneNumber) {
    ...
    public Outlet locale(String locale) {
        this.locale = locale;
        return this;
    }
    ...
    public Outlet halal(Boolean halal) {
        this.halal = halal;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.clientVendorId, outlet.clientVendorId) &&
                Objects.equals(this.name, outlet.name) &&
                Objects.equals(this.address, outlet.address) &&
                Objects.equals(this.street, outlet.street) &&
                Objects.equals(this.streetNumber, outlet.streetNumber) &&
                Objects.equals(this.building, outlet.building) &&
                Objects.equals(this.district, outlet.district) &&
                Objects.equals(this.postalCode, outlet.postalCode) &&
                Objects.equals(this.riderInstructions, outlet.riderInstructions) &&
                Objects.equals(this.latitude, outlet.latitude) &&
                Objects.equals(this.longitude, outlet.longitude) &&
                Objects.equals(this.city, outlet.city) &&
                Objects.equals(this.phoneNumber, outlet.phoneNumber) &&
                Objects.equals(this.currency, outlet.currency) &&
                Objects.equals(this.description, outlet.description) &&
                Objects.equals(this.locale, outlet.locale) &&
                Objects.equals(this.halal, outlet.halal);
    }

    @Override
    public int hashCode() {
        return Objects.hash(clientVendorId, name, address, street, streetNumber, building, district, postalCode, riderInstructions, latitude, longitude, city, phoneNumber, currency, description, locale, halal);
    }
