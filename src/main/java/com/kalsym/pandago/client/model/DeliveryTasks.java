...
public class DeliveryTasks {
  @JsonProperty("age_validation_required")
  private Boolean ageValidationRequired = null;

  public DeliveryTasks ageValidationRequired(Boolean ageValidationRequired) {
    this.ageValidationRequired = ageValidationRequired;
    return this;
  }

   /**
   * Get ageValidationRequired
   * @return ageValidationRequired
  **/
  @ApiModelProperty(value = "")
  public Boolean getAgeValidationRequired() {
    return ageValidationRequired;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeliveryTasks deliveryTasks = (DeliveryTasks) o;
    return Objects.equals(this.ageValidationRequired, deliveryTasks.ageValidationRequired);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ageValidationRequired);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeliveryTasks {\n");
    
    sb.append("    ageValidationRequired: ").append(toIndentedString(ageValidationRequired)).append("\n");
    sb.append("}");
    return sb.toString();
  }
