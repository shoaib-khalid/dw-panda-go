package com.kalsym.pandago.client.client.invoker;

import com.kalsym.pandago.client.client.invoker.auth.ApiKeyAuth;
import com.kalsym.pandago.client.client.invoker.auth.Authentication;
import com.kalsym.pandago.client.client.invoker.auth.HttpBasicAuth;
import com.kalsym.pandago.client.client.invoker.auth.OAuth;
...
public class ApiClient {
    ...
    protected void init() {
        ...
        authentications.put("Bearer Token", new ApiKeyAuth("header", "Authorization"));
