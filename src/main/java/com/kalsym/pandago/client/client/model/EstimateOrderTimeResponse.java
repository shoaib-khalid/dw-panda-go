...
public class EstimateOrderTimeResponse {
  @JsonProperty("client_order_id")
  private String clientOrderId = null;

  @JsonProperty("estimate_pickup_time")
  private String estimatePickupTime = null;

  @JsonProperty("estimate_delivery_time")
  private String estimateDeliveryTime = null;

  public EstimateOrderTimeResponse clientOrderId(String clientOrderId) {
  ...
  **/
  ...
  public EstimateOrderTimeResponse estimatePickupTime(String estimatePickupTime) {
    this.estimatePickupTime = estimatePickupTime;
    return this;
  }

   /**
   * Get estimatePickupTime
  ...
  **/
  ...
  public EstimateOrderTimeResponse estimateDeliveryTime(String estimateDeliveryTime) {
    this.estimateDeliveryTime = estimateDeliveryTime;
    return this;
  }

   /**
   * Get estimateDeliveryTime
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EstimateOrderTimeResponse estimateOrderTimeResponse = (EstimateOrderTimeResponse) o;
    return Objects.equals(this.clientOrderId, estimateOrderTimeResponse.clientOrderId) &&
        Objects.equals(this.estimatePickupTime, estimateOrderTimeResponse.estimatePickupTime) &&
        Objects.equals(this.estimateDeliveryTime, estimateOrderTimeResponse.estimateDeliveryTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientOrderId, estimatePickupTime, estimateDeliveryTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class EstimateOrderTimeResponse {\n");
    
    sb.append("    clientOrderId: ").append(toIndentedString(clientOrderId)).append("\n");
    sb.append("    estimatePickupTime: ").append(toIndentedString(estimatePickupTime)).append("\n");
    sb.append("    estimateDeliveryTime: ").append(toIndentedString(estimateDeliveryTime)).append("\n");
    sb.append("}");
    return sb.toString();
  }
